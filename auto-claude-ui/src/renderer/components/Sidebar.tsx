...
export type SidebarView = 'kanban' | 'terminals' | 'roadmap' | 'context' | 'ideation' | 'github-issues' | 'changelog' | 'insights' | 'worktrees' | 'agent-tools' | 'skills';
...
const toolsNavItems: NavItem[] = [
  ...
  { id: 'skills', label: 'Skills', icon: Wand2, shortcut: 'S' }
];
